  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>护肤品</el-breadcrumb-item>
        <el-breadcrumb-item>贺本清</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
</el-row>
          ...
          <div v-for="value in attributes" class="text item">
            <el-row>
              <dl class="attribute-list">
                ...
                <el-col :span="6"><div><dd title="effect">功效:&nbsp;&nbsp;{{value.effect}}</dd></div></el-col>
    ...
    series : [
        {
            name:'销量变化',
            type:'line',
            data:[36,36,36,35,35,35,35,
            35,35,277,266,266,297,297,277,
            299,261,257,254,256,253,213,221,218,
            215,269,269,269,252,252,252,252,275,
            298,277,277,277,307,261,276,271,295,286,286,287],
            markPoint : {
                data : [
                    {type : 'max', name: '最大值'},
                    {type : 'min', name: '最小值'}
            ...
            getData(){
                console.log("===getData====")
                axios.get('/getskincare', {page:self.cur_page}).then((res) => { 
                  console.log(res) 
                  let res1 = res.data.skincare
                  var arr=res1.list.filter(function(ele){
                    return ele.brand.includes("Herbacin/贺本清")
                  })
                  console.log(arr)
                this.tableData = arr
            ...
            handleRowClick(val){
              ...
              axios.get('/getskinAttributes').then((res) => { 
                console.log(res) 
                let res1 = res.data.skinA
                var arr=res1.list.filter(function(ele){
