  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>日常用品</el-breadcrumb-item>
        <el-breadcrumb-item>Facelle</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
</el-row>
          ...
          <div v-for="value in attributes" class="text item">
            <el-row>
              <dl class="attribute-list">
                ...
                <el-col :span="6"><div><dd title="series">系列:&nbsp;&nbsp;{{value.series}}</dd></div></el-col>
                <el-col :span="6"><div><dd title="ages">适用性别:&nbsp;&nbsp;{{value.ages}}</dd></div></el-col>
                <el-col :span="6"><div><dd title="suit">使用:&nbsp;&nbsp;{{value.suit}}</dd></div></el-col>
                <el-col :span="6"><div><dd title="material">材质:&nbsp;&nbsp;{{value.material}}</dd></div></el-col>
    ...
    series : [
        {
            name:'销量变化',
            type:'line',
            data:[185,182,188,191,193,206,232,
            246,232,213,218,218,218,218,206,200,227,
            226,230,230,230,206,201,212,183,210,
            194,194,178,124,180,180,189,180,179,
            141,192,176,176,202,208,197,207,213,219],
            markPoint : {
                data : [
                    {type : 'max', name: '最大值'},
                    {type : 'min', name: '最小值'}
            ...
            getData(){
                console.log("===getData====")
                axios.get('/getdailySupplies', {page:self.cur_page}).then((res) => { 
                  console.log(res) 
                  let res1 = res.data.dailySupplies
                  var arr=res1.list.filter(function(ele){
                    return ele.brand.includes("Facelle")
                  })
                  console.log(arr)
                this.tableData = arr
            ...
            handleRowClick(val){
              ...
              axios.get('/getdailyAttributes').then((res) => { 
                console.log(res) 
                let res1 = res.data.dailyA
                var arr=res1.list.filter(function(ele){
